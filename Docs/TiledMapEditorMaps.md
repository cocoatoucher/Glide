...
<p align="center">
    <img src="TiledMapEditor/Screenshots/1.1.newMap.png" width="200" max-width="80%"/>
</p>
- Create a new map file with your desired setup. Map orientation should be `Orthogonal`.

<p align="center">
    <img src="TiledMapEditor/Screenshots/1.2.mapJson.png" width="200" max-width="80%"/>
</p>
...
<p align="center">
    <img src="TiledMapEditor/Screenshots/collidableLayer.png" width="200" max-width="80%"/>
</p>
- Download [Glide collider tile set](Docs/TiledMapEditor/GlideColliderTileset.zip) that is created for you and unzip it. This tile set is created with 16x16 tiles and can be used with 16x16 tile maps. To see how to create a new tile set from scratch see below section for decoration layer.

<p align="center">
    <img src="TiledMapEditor/Screenshots/2.1.dragColliderTileset.png" width="200" max-width="80%"/>
</p>
...
<p align="center">
    <img src="TiledMapEditor/Screenshots/2.2.createTileLayer.png" width="200" max-width="80%"/>
    <img src="TiledMapEditor/Screenshots/2.3.newGroundLayer.png" width="200" max-width="80%"/>
</p>
...
<p align="center">
    <img src="TiledMapEditor/Screenshots/2.4.paintTiles.png" width="200" max-width="80%"/>
</p>
...
<p align="center">
    <img src="TiledMapEditor/Screenshots/decorationLayer.png" width="200" max-width="80%"/>
</p>
...
<p align="center">
    <img src="TiledMapEditor/Screenshots/3.1.newTileset.png" width="200" max-width="80%"/>
    <img src="TiledMapEditor/Screenshots/3.2.newTileset.png" width="200" max-width="80%"/>
    <img src="TiledMapEditor/Screenshots/3.3.newTileset.png" width="200" max-width="80%"/>
</p>
...
<p align="center">
    <img src="TiledMapEditor/Screenshots/3.4.editTileSet.png" width="200" max-width="80%"/>
    <img src="TiledMapEditor/Screenshots/3.5.populate_tileset.png" width="200" max-width="80%"/>
</p>
...
<p align="center">
    <img src="TiledMapEditor/Screenshots/3.6.shouldSkip.png" width="200" max-width="80%"/>
</p>
...
<p align="center">
    <img src="TiledMapEditor/Screenshots/3.7.collidableLayerOffsets.png" width="200" max-width="80%"/>
</p>
